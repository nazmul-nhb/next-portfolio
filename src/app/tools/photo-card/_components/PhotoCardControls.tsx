                ...
                <div className="space-y-1.5">
                    <Card className="rounded-none">
                        <CardHeader>
                            <CardTitle className="flex items-center gap-2">
                                <Palette className="size-5" /> Canvas Settings
                            </CardTitle>
                            <CardDescription>
                                Draft values stay editable until blur or Enter, so the inputs
                                stop jumping while you type.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-4 sm:grid-cols-3">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <ColorInputField
                                    ...
                                    onChange={(value) =>
                                        onCanvasChange({ backgroundColor: value })
                                    }
                    ...
                    <Card className="rounded-none">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Turn sections on when you want dedicated branded strips with
                                their own colors, images, and text layers.
                            </CardDescription>
                        </CardHeader>
                                    ...
                                    >
                                        <div className="flex items-center justify-between gap-3">
                                            <div>
                                                ...
                                                <p className="text-xs text-muted-foreground">
                                                    Add images and text directly inside the{' '}
                                                    {sectionKey}.
                                                </p>
                                            </div>
                                        ...
                                        <div className="flex flex-wrap gap-2 justify-between">
                                            <div className="space-y-2 md:flex-1 shrink-0">
                                                <Label htmlFor={`${sectionKey}-height`}>
                                                    Height
                                                </Label>
                                                <DraftNumberInput
        ...
        },
        {
            ...
            section: (
                <Card className="rounded-none">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            <Image className="size-5" /> Image Layers
                        </CardTitle>
                        <CardDescription>
                ...
                <Card className="rounded-none">
                    <CardHeader>
                        <div className="flex flex-wrap items-start justify-between gap-3">
                            <div>
                                <CardTitle className="flex items-center gap-2">
                                    <Type className="size-5" /> Text Layers
                                </CardTitle>
                                <CardDescription>
                                    Add text to the canvas, header, or footer, then drag it
                                    directly in the stage.
                                </CardDescription>
                            </div>
                ...
                <div className="space-y-1.5">
                    ...
                    <Card className="rounded-none">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Everything stays in this browser. You can reload a saved
                                configuration or export it later.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            {savedCardsLoading ? (
                                    ...
                                    {savedCards.map((card) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex flex-wrap gap-1">
                                                ...
                                                <Button
                                                    onClick={() =>
                                                        onDownloadSaved(card, 'image/png')
                                                    }
                                                    size="sm"
                                                    type="button"
                                                    variant="outline"
                                                ...
                                                <Button
                                                    onClick={() =>
                                                        onDownloadSaved(card, 'image/jpeg')
                                                    }
                                                    size="sm"
                                                    type="button"
                                                    variant="outline"
        ...
        <div className="space-y-6 max-w-full mx-auto max-h-fit">
            ...
            <Tabs defaultValue="canvas">
                <TabsList variant="line">
                    {TABS.map(({ id }) => (
                        <TabsTrigger
                            className="text-sm font-cascadia uppercase"
                            key={id}
                            value={id}
                        >
                            {id}
