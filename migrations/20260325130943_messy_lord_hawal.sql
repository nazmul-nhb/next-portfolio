ALTER TABLE "poll_votes" ADD COLUMN "option_id" integer;--> statement-breakpoint
...
) WHERE "option_id" IS NULL;--> statement-breakpoint
DELETE FROM "poll_votes" WHERE "option_id" IS NULL;--> statement-breakpoint
ALTER TABLE "poll_votes" ALTER COLUMN "option_id" SET NOT NULL;--> statement-breakpoint
